/**
 * Author: Rick Mercer and Abhishek Sharma ObstacleCourse: A type that
 * represents an obstacle course from which to escape. This does not find the
 * shorted path. Because of this, we must always assume there is only one exit.
 */
public class ObstacleCourse {
	...
	public boolean isBorder(int row, int col) {
		return (row == course.length - 1 || col == course[0].length - 1
				|| row == 0 || col == 0);
